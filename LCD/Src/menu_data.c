...
static xScreenObjet  const SettingsTimeScreen[]=
{
  ...
  {4U,FONT_SIZE*1U, LINE1+6U,100U, LINE4_HIGTH, INPUT_HW_DATA, InputParam3,NULL,(void*)&vGetTIMEForMenu, HOUR},
  {4U,FONT_SIZE*5U, LINE1+6U,100U, LINE4_HIGTH, INPUT_HW_DATA, InputParam4,NULL,(void*)&vGetTIMEForMenu,MINUTE},
  {4U,FONT_SIZE*1U, LINE3+3U,100U, LINE4_HIGTH, INPUT_HW_DATA, InputParam5,NULL,(void*)&vGetTIMEForMenu, DAY},
  {4U,FONT_SIZE*5U, LINE3+3U,100U, LINE4_HIGTH, INPUT_HW_DATA, InputParam6,NULL,(void*)&vGetTIMEForMenu,MOUNTH},
  {4U,FONT_SIZE*15U, LINE3+3U,100U, LINE4_HIGTH, INPUT_HW_DATA, InputParam7,NULL,(void*)&vGetTIMEForMenu,YEAR},
