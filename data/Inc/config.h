...
#define   FUEL_LEVEL_LOW_ALARM_LEVEL_ADR                         20U
#define   FUEL_LEVEL_LOW_ALARM_DELAY_ADR                         21U
#define   FUEL_LEVEL_LOW_PRE_ALARM_LEVEL_ADR                     22U
#define   FUEL_LEVEL_LOW_PRE_ALARM_DELAY_ADR                     23U
#define   FUEL_LEVEL_HIGHT_PRE_ALARM_LEVEL_ADR                   24U
#define   FUEL_LEVEL_HIGHT_PRE_ALARM_DELAY_ADR                   25U
#define   FUEL_LEVEL_HIGHT_ALARM_LEVEL_ADR                       26U
#define   FUEL_LEVEL_HIGHT_ALARM_DELAY_ADR                       27U
#define   FUEL_PUMP_ON_LEVEL_ADR                                 28U
#define   FUEL_PUMP_OFF_LEVEL_ADR                                29U
#define   SPEED_SETUP_ADR                                        30U
#define   SPEED_TOOTH_NUMBER_ADR                                 31U
#define   SPEED_LOW_ALARM_LEVEL_ADR                              32U
#define   SPEED_HIGHT_ALARM_LEVEL_ADR                            33U
#define   DIA_SETUP_ADR                                          34U
#define   DIA_DELAY_ADR                                          35U
#define   DIA_MESSAGE_ADR                                        36U
#define   DIB_SETUP_ADR                                          37U
#define   DIB_DELAY_ADR                                          38U
#define   DIB_MESSAGE_ADR                                        39U
#define   DIC_SETUP_ADR                                          40U
#define   DIC_DELAY_ADR                                          41U
#define   DIC_MESSAGE_ADR                                        42U
#define   DID_SETUP_ADR                                          43U
#define   DID_DELAY_ADR                                          44U
#define   DID_MESSAGE_ADR                                        45U
#define   DO_SETUP_ADR                                           46U
#define   DOAB_TYPE_ADR                                          47U
#define   DOCD_TYPE_ADR                                          48U
#define   DOEF_TYPE_ADR                                          49U
#define   TIMER_MAINS_TRANSIENT_DELAY_ADR                        50U
#define   TIMER_START_DELAY_ADR                                  51U
#define   TIMER_CRANKING_ADR                                     52U
#define   TIMER_CRANK_DELAY_ADR                                  53U
#define   TIMER_STARTUP_IDLE_TIME_ADR                            54U
#define   TIMER_NOMINAL_R_P_M_DELAY_ADR                          55U
#define   TIMER_SAFETY_ON_DELAY_ADR                              56U
#define   TIMER_WARMING_ADR                                      57U
#define   TIMER_TRANSFER_DELAY_ADR                               58U
#define   TIMER_GEN_BREAKER_TRIP_PULSE_ADR                       59U
#define   TIMER_GEN_BREAKER_CLOSE_PULSE_ADR                      60U
#define   TIMER_MAINS_BREAKER_TRIP_PULSE_ADR                     61U
#define   TIMER_MAINS_BREAKER_CLOSE_PULSE_ADR                    62U
#define   TIMER_RETURN_DELAY_ADR                                 63U
#define   TIMER_COOLING_ADR                                      64U
#define   TIMER_COOLING_IDLE_ADR                                 65U
#define   TIMER_SOLENOID_HOLD_ADR                                66U
#define   TIMER_FAIL_STOP_DELAY_ADR                              67U
#define   TIMER_GEN_TRANSIENT_DELAY_ADR                          68U
#define   GEN_SETUP_ADR                                          69U
#define   GEN_RATED_ACTIVE_POWER_LEVEL_ADR                       70U
#define   GEN_RATED_REACTIVE_POWER_LEVEL_ADR                     71U
#define   GEN_RATED_APPARENT_POWER_LEVEL_ADR                     72U
#define   GEN_RATED_FREQUENCY_LEVEL_ADR                          73U
#define   GEN_CURRENT_PRIMARY_LEVEL_ADR                          74U
#define   GEN_CURRENT_FULL_LOAD_RATING_LEVEL_ADR                 75U
#define   GEN_CURRENT_TRASFORM_RATIO_LEVEL_ADR                   76U
#define   GEN_ALARMS_ADR                                         77U
#define   GEN_UNDER_VOLTAGE_ALARM_LEVEL_ADR                      78U
#define   GEN_UNDER_VOLTAGE_PRE_ALARM_LEVEL_ADR                  79U
#define   GEN_OVER_VOLTAGE_PRE_ALARM_LEVEL_ADR                   80U
#define   GEN_OVER_VOLTAGE_ALARM_LEVEL_ADR                       81U
#define   GEN_UNDER_FREQUENCY_ALARM_LEVEL_ADR                    82U
#define   GEN_UNDER_FREQUENCY_PRE_ALARM_LEVEL_ADR                83U
#define   GEN_OVER_FREQUENCY_PRE_ALARM_LEVEL_ADR                 84U
#define   GEN_OVER_FREQUENCY_ALARM_LEVEL_ADR                     85U
#define   GEN_OVER_CURRENT_THERMAL_PROTECTION_LEVEL_ADR          86U
#define   GEN_OVER_CURRENT_CUTOFF_LEVEL_ADR                      87U
#define   GEN_OVER_CURRENT_ALARM_LEVEL_ADR                       88U
#define   GEN_OVER_CURRENT_ALARM_DELAY_ADR                       89U
#define   GEN_CURRENT_OVERLOAD_PROTECTION_LEVEL_ADR              90U
#define   GEN_CURRENT_OVERLOAD_PROTECTION_DELAY_ADR              91U
#define   GEN_CURRENT_OVER_PHASE_IMBALANCE_LEVEL_ADR             92U
#define   GEN_CURRENT_OVER_PHASE_IMBALANCE_DELAY_ADR             93U
#define   MAINS_SETUP_ADR                                        94U
#define   MAINS_ALARMS_ADR                                       95U
#define   MAINS_UNDER_VOLTAGE_ALARM_LEVEL_ADR                    96U
#define   MAINS_OVER_VOLTAGE_ALARM_LEVEL_ADR                     97U
#define   MAINS_UNDER_FREQUENCY_ALARM_LEVEL_ADR                  98U
#define   MAINS_OVER_FREQUENCY_ALARM_LEVEL_ADR                   99U
#define   ENGINE_SETUP_ADR                                       100U
#define   ENGINE_PRE_HEAT_LEVEL_ADR                              101U
#define   ENGINE_PRE_HEAT_DELAY_ADR                              102U
#define   STARTER_STOP_SETUP_ADR                                 103U
#define   STARTER_STOP_GEN_FREQ_LEVEL_ADR                        104U
#define   STARTER_STOP_OIL_PRESSURE_LEVEL_ADR                    105U
#define   STARTER_STOP_CHARGE_ALTERNATOR_LEVEL_ADR               106U
#define   STARTER_STOP_SPEED_LEVEL_ADR                           107U
#define   BATTERY_ALARMS_ADR                                     108U
#define   BATTERY_UNDER_VOLTAGE_LEVEL_ADR                        109U
#define   BATTERY_UNDER_VOLTAGE_DELAY_ADR                        110U
#define   BATTERY_OVER_VOLTAGE_LEVEL_ADR                         111U
#define   BATTERY_OVER_VOLTAGE_DELAY_ADR                         112U
#define   BATTERY_CHARGE_SHUTDOWN_LEVEL_ADR                      113U
#define   BATTERY_CHARGE_SHUTDOWN_DELAY_ADR                      114U
#define   BATTERY_CHARGE_WARNING_LEVEL_ADR                       115U
#define   BATTERY_CHARGE_WARNING_DELAY_ADR                       116U
#define   MAINTENANCE_ALARMS_ADR                                 117U
#define   MAINTENANCE_ALARM_OIL_TIME_ADR                         118U
#define   MAINTENANCE_ALARM_AIR_TIME_ADR                         119U
#define   MAINTENANCE_ALARM_FUEL_TIME_ADR                        120U
#define   LOG_SETUP_ADR                                          121U
#define   RECORD_SETUP_ADR                                       122U
#define   RECORD_INTERVAL_ADR                                    123U
/*---------------------- Bitmap addresses ------------------------------*/
