...
#define  STORAGE_LOG_SIZE       9216U                              /* byte */
#define  STORAGE_REQUIRED_SIZE  ( STORAGE_SR_SIZE + STORAGE_WEB_SIZE + STORAGE_CONFIG_SIZE + STORAGE_CHART_SIZE + STORAGE_RESERVE_SIZE + STORAGE_LOG_SIZE )
