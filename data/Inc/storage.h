...
#define  STORAGE_REQUIRED_SIZE    ( STORAGE_SR_SIZE + STORAGE_WEB_SIZE + STORAGE_RESERVE_SIZE + STORAGE_CONFIG_SIZE + STORAGE_CHART_SIZE + STORAGE_FREE_DATA_SIZE + STORAGE_PASSWORD_SIZE + STORAGE_LOG_POINTER_SIZE + STORAGE_LOG_SIZE + STORAGE_JOURNAL_SIZE)
