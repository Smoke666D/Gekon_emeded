...
{
   { 1U, 0U, 0U, 1U },     // speedEnb
   { 2U, 1U, 0U, 1U },     // speedLowAlarmEnb
};
...
{
   { 1U, 0U, 0U, 1U },     // starterOilPressureCheckOnStartEnb
   { 2U, 1U, 0U, 1U },     // starterStopOilPressureEnb
   { 4U, 2U, 0U, 1U },     // starterStopChargeAlternatorEnb
   { 8U, 3U, 0U, 1U },     // starterStopSpeedEnb
};
...
{
   { 1U, 0U, 0U, 1U },     // logSaveWarningEventsEnb
};
