...
uint16_t coolantTempSetupValue[1U] = { 115U };
...
/*----------------------------------------------------------------*/
uint16_t genCurrentTrasformRatioLevelValue[1U] = { 1U };
