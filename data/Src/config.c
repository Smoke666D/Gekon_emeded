...
uint16_t versionControllerValue[3U] = { 0U, 0U, 0U };
...
/*----------------------------------------------------------------*/
uint16_t versionFirmwareValue[3U] = { 0U, 0U, 0U };
...
/*----------------------------------------------------------------*/
uint16_t versionBootloaderValue[3U] = { 0U, 0U, 0U };
...
/*----------------------------------------------------------------*/
uint16_t uniqueNumber0Value[3U] = { 0U, 0U, 0U };
const eConfigAttributes uniqueNumber0Atrib =
{
   .adr        = 4U,
   .scale      = 0U,
   .min        = 0U,
...
eConfigReg uniqueNumber0 =
{
   .atrib = &uniqueNumber0Atrib,
   .value = uniqueNumber0Value,
};
/*----------------------------------------------------------------*/
uint16_t uniqueNumber1Value[3U] = { 0U, 0U, 0U };
const eConfigAttributes uniqueNumber1Atrib =
{
   .adr        = 5U,
   .scale      = 0U,
   .min        = 0U,
...
eConfigReg uniqueNumber1 =
{
   .atrib = &uniqueNumber1Atrib,
   .value = uniqueNumber1Value,
};
/*----------------------------------------------------------------*/
uint16_t macAddressValue[3U] = { 0U, 0U, 0U };
const eConfigAttributes macAddressAtrib =
{
   .adr        = 6U,
   .scale      = 0U,
   .min        = 0U,
...
eConfigReg macAddress =
{
   .atrib = &macAddressAtrib,
   .value = macAddressValue,
};
/*----------------------------------------------------------------*/
uint16_t releaseDateValue[3U] = { 0U, 0U, 0U };
const eConfigAttributes releaseDateAtrib =
{
   .adr        = 7U,
   .scale      = 0U,
   .min        = 0U,
...
eConfigReg releaseDate =
{
   .atrib = &releaseDateAtrib,
