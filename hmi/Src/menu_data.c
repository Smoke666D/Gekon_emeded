...
static xScreenObjet const InfoMainScreen[]=
{
  ...
  {0U,LEFT_OFFSET,LINE1+6U,125U,LINE4_HIGTH,HW_DATA,RigthText,NULL,(void*)vGetDataForMenu,SW_VER},
  {0U,LEFT_OFFSET,LINE3,0U,0U,TEXT_STRING,LeftText,"Версия апр.:",NULL,0U},
  {0U,LEFT_OFFSET,LINE2+3U,125U,LINE4_HIGTH,HW_DATA,RigthText,NULL,(void*)vGetDataForMenu,HW_VER},
