...
typedef enum
{
  ...
  USB_REPORT_CMD_GET_DOT                = 0x05U,
  USB_REPORT_CMD_PUT_DOT                = 0x06U,
  USB_REPORT_CMD_PUT_EWA                = 0x07U,
  USB_REPORT_CMD_SAVE_CONFIG            = 0x08U,
  USB_REPORT_CMD_SAVE_CHART             = 0x09U,
  USB_REPORT_CMD_GET_TIME               = 0x0AU,
  USB_REPORT_CMD_PUT_TIME               = 0x0BU,
  USB_REPORT_CMD_GET_FREE_DATA          = 0x0CU,
  USB_REPORT_CMD_PUT_FREE_DATA          = 0x0DU,
  USB_REPORT_CMD_GET_LOG                = 0x0EU,
  USB_REPORT_CMD_ERASE_LOG              = 0x0FU,
  USB_REPORT_CMD_PUT_PASSWORD           = 0x10U,
  USB_REPORT_CMD_AUTHORIZATION          = 0x11U,
  USB_REPORT_CMD_ERASE_PASSWORD         = 0x12U,
  USB_REPORT_CMD_GET_MEMORY_SIZE        = 0x13U,
  USB_REPORT_CMD_GET_MEASUREMENT        = 0x14U,
  USB_REPORT_CMD_ERASE_MEASUREMENT      = 0x15U,
  USB_REPORT_CMD_GET_MEASUREMENT_LENGTH = 0x16U,
} USB_REPORT_CMD;
/*------------------------------ Default -------------------------------------*/
